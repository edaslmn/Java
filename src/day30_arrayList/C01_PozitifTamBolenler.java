...
public class C01_PozitifTamBolenler {
    public static void main(String[] args) {
        ...
        // verilen pozitif bir tam sayıyı,
        // tam bolebilen tum pozitif tamsayılari bir liste olarak bize donduren bir method olusturun
        // örnek input: 20 return ==> [1, 2, 4, 5, 10, 20]
