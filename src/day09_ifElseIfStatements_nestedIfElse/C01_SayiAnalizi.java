...
public class C01_SayiAnalizi {
    ...
    public static void main(String[] args) {
        ...
        else if (sayi < 10) System.out.println("Girdiğiniz sayi rakam.");
        else if (sayi < 100) System.out.println("İki basamaklı sayi");
        else if (sayi < 1000) System.out.println("Üç basamaklı sayi.");
