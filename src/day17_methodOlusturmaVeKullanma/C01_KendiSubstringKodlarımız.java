...
public class C01_KendiSubstringKodlarımız {
    public static void main(String[] args) {
       ...
       /*
        ...
        if (basIndex < 0 || bitIndex < 0 || basIndex >= metin.length() || bitIndex >= metin.length()) {
            System.out.println("Girilen index geçersiz, metnin length'i " + metin.length());
        } else if (basIndex > bitIndex) {
            System.out.println("Baslangıc index'i bitis index'inden büyük olamaz.");
        } else {
